            ...
            <main class="content__main">
                ...
                <form class="form" action="index.php" method="post">
                    <div class="form__row">
                        ...
                        <?= $registrationErrors["emailEmptyError"] ? "<p class=\"form__message\">Введите свой e-mail</p>" : "" ?>

                        <?= $registrationErrors["emailValidityError"] ? "<p class=\"form__message\">E-mail введён некорректно</p>" : "" ?>

                        <?= $registrationErrors["emailTakenError"] ? "<p class=\"form__message\">Этот email уже существует</p>" : "" ?>
                    </div>
                    ...
                    <div class="form__row">
                        ...
                        <?= $registrationErrors["passwordError"] ? "<p class=\"form__message\">Введите свой пароль</p>" : "" ?>
                    </div>
                    ...
                    <div class="form__row">
                        ...
                        <?= $registrationErrors["nameError"] ? "<p class=\"form__message\">Введите свое имя</p>" : "" ?>
                    </div>
