<div class="modal" <?= $_GET["page"] == "login" ? "" : "hidden " ?>id="user_login">
    ...
    <form class="form" action="" method="post">
        <div class="form__row">
            ...
            <?= $loginErrors["emptyEmail"] ? "<p class=\"form__message\">Введите свой e-mail</p>" : "" ?>
        ...
        <div class="form__row">
            ...
            <?= $loginErrors["emptyPassword"] ? "<p class=\"form__message\">Введите свой пароль</p>" : "" ?>
